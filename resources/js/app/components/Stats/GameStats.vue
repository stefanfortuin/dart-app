<template>
  <div class="flex justify-between font-bold text-blue-500 text-xl">
  ...
  <div class="my-1">
    <div class="flex justify-between items-center mb-1">
      ...
      <div class="font-semibold text-blue-500">Sets</div>
      <div class="font-bold">{{ users[1].stats["sets_won"] }}</div>
    </div>
    <div class="grid grid-cols-2 gap-3">
      <progress-bar
        :max="total_sets"
        :value="users[0].stats['sets_won']"
        alignRight="true"
      />
      <progress-bar :max="total_sets" :value="users[1].stats['sets_won']" />
    </div>
  </div>
  ...
  <div class="my-1">
    ...
    <div class="grid grid-cols-2 gap-3">
      <progress-bar
        ...
        alignRight="true"
      />
      <progress-bar :max="total_legs" :value="users[1].stats['legs_won']" />
    </div>
  </div>
  ...
  <div class="my-1">
    ...
    <div class="grid grid-cols-2 gap-3">
      <progress-bar
        ...
        alignRight="true"
      />
      <progress-bar :max="180" :value="users[1].stats['average_per_turn']" />
    </div>
  </div>
  ...
  <div class="my-1">
    ...
    <div class="grid grid-cols-2 gap-3">
      <progress-bar
        ...
        alignRight="true"
      />
      <progress-bar :max="180" :value="users[1].stats['highest']" />
    </div>
  </div>
</template>
