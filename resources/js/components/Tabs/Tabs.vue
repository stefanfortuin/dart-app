<template>
	<div class="w-full flex-grow h-full max-h-full flex my-2">
		
		<div class="p-1 px-2 w-10/12 flex-1 h-full min-h-32 max-h-full bg-blue-500 rounded-b-lg rounded-tl-lg">
